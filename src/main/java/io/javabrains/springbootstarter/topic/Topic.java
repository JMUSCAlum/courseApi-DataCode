...
public class Topic {
	...
	public Topic(String id, String crn, String subj, String crse, String sec, String cmp, String cred,
			String part_of_term, String title, String days, String time, String cap, String act, String rem,
			String instructor, String date, String location, String attribute) {
		super();
		this.id = id;
		this.crn = crn;
		this.subj = subj;
